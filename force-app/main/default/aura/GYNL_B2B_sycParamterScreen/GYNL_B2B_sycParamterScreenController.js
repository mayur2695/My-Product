({
    ...
    saveRec : function(component,event,helper) {
        ...
        //Pricing 
         if(Tabvalue == 'Pricing'){
            finalList =component.get("v.PricingList");
        }
        //if for Pricing ends
    ...
    AddFiltervalueToField : function (component, event) {
        ...
        // ---------------------Pricing Stuff------------
         if(Tabvalue == 'Pricing'){
            ...
            if(fieldSAPName === 'KSCHL'){
                component.set("v.PricingList.GYNCF_Condition_Type__c ",newStr);
            }
            if(fieldSAPName === 'KEY'){
                component.set("v.PricingList.GYNCF_Key__c ",newStr);
            }
            if(fieldSAPName === 'VTWEG'){
                component.set("v.PricingList.GYNCF_Distribution_Channel__c ",newStr);
            }
            if(fieldSAPName === 'SPART'){
                component.set("v.PricingList.GYNCF_Division__c ",newStr);
            }       
        }
        //-------------------------------------------------
        if(Tabvalue == 'Customer'){
