({
    ...
    handlecreate : function(component, event, helper) {
        ...
        console.log('component.get("v.fetchedData")'+component.get("v.fetchedData"));
        if(component.get("v.fetchedData") != null){
            var picklist =  JSON.stringify(component.get("v.fetchedData"));
        }
